...
const PasswordInputField = ({children,onChangeText,value}) => {
  ...
  return (
    <View style={{gap:8}} className='flex w-[100%]'>
      ...
      <TextInput value={value} onChangeText={onChangeText} style={{fontFamily:"Cabinet-Grotesk-Bold"}} secureTextEntry={showPassword} selectionColor={'#666666'} className='w-[85%] bg-light-900 h-[54px] rounded-md text-justify text-lg  pb-[5px]'/>
